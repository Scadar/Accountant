...
public class MainMenu extends JMenuBar implements Refresh, EnableEditDelete {
    ...
    private JMenuItem addMenuItem(JMenu menu, Handler listener, String title, Icon icon, String action, int key){
    ...
    private JMenuItem addMenuItem(JMenu menu, Handler listener, String title, Icon icon, String action){
